...
public class Escritorio extends javax.swing.JPanel {
    ...
    public Escritorio() {
        initComponents();
        nombre.setText(Clases.Usuario.getNombre());
        try {
            n = Nota();
            while(n.next()){
                jTextArea1.setText(n.getString(1));
            }
        } catch (SQLException ex) {
        }
        try {
            int li=0,re=0;
            n = getS().executeQuery("SELECT estado FROM habitacion");
            while(n.next()){
                if(n.getString(1).equals("0")){
                    li++;
                } else if(n.getString(1).equals("1")) {
                    re++;
                }
            }
            jLabel18.setText(li+"");
            jLabel20.setText(re+"");
            n = getS().executeQuery("SELECT ruc FROM cliente");
            while(n.next()){
                li++;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ESTADÍSTICAS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(204, 0, 0))); // NOI18N

        jPanel4.setBackground(new java.awt.Color(204, 0, 0));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("TOTAL CLIENTES");
        ...
        jLabel17.setText("TOTAL EMPRESAS");
        ...
        jLabel21.setText("TOTAL RESERVAS");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "NOTA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(204, 0, 0))); // NOI18N

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("Esta será una nota que el administrador o\ncajera guardara para notificar de algún\nevento o error.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            getS().executeUpdate("INSERT INTO notas(nota) VALUES ('"+jTextArea1.getText()+"')");
        } catch (SQLException ex) {
